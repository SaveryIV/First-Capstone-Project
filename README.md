...
**[Capstone Project]** is the last project in the first module in the Microverse course the objective is start making projects with a orientation to the real world statements of working in functional and professional websites. Iam proud to say i finish the first version, and alredy count with functionalities, and features that makes this project alredy functional, as well i take care of the design trying to replicate the design of Cindy Shin. So please, give it a try and test my page, enjoy!
...
- **[In the project i been using HTML, CSS and Javascript]**
- **[Flexbox for the design and Responsive design]**
- **[Also the page is deploied in GitHub Pages]**
...
- [ ] **[Deploy and functionalities with React.js]**
- [ ] **[Use of databases like Ruby or MySQL]**
